...
import { LiveSessionService, type UpdateLiveSessionDto, type LiveSession } from '@/services/live-session.service';
...
const EditLiveSessionPage = () => {
    ...
    const [formData, setFormData] = useState<UpdateLiveSessionDto>({});
    ...
    // Populate form data when session data is loaded
    useEffect(() => {
    ...
    const updateMutation = useMutation({
        mutationFn: (data: UpdateLiveSessionDto) => LiveSessionService.updateLiveSession(sessionId, data),
        onSuccess: (response) => {
        ...
        onError: (error: any) => {
            ...
            setErrors({ general: 'Failed to update live session. Please try again.' });
        },
    });
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Update session details and settings</p>
                    </div>
                </div>
            </div>
